...
const BeanOutput = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      // const response = await apiClient.post('/ch2/bean-output', 
  ...
  return (
    <>
      <h2 className="text-center">4. Structured Output Converter - Bean Output Converter</h2>
