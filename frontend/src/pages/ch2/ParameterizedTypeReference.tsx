...
const ParameterizedTypeReference = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      // const response = await apiClient.post('/ch2/parameterized-type-reference', 
  ...
  return (
    <>
      <h2 className="text-center">5. Structured Output Converter - Parameterized Type Reference</h2>
...
export default ParameterizedTypeReference;
