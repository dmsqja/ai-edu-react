...
const Recommendation = () => {
  const [question, setQuestion] = useState('고객이 좋아할 만한 제품 추천해줘');
  const [userId, setUserId] = useState('id01');
  ...
  return (
    <>
      <h2 className="text-center">3. Shopping Tools</h2>
              ...
              <div className="card-header text-muted d-flex justify-content-start align-items-center p-3">
                <div className="input-group mb-0">
                  <div className="input-group p-1">
                    ...
                    >
                      <option value="id01">id01</option>
                      <option value="id02">id02</option>
                    </select>
                  </div>
                  <input
                    id="question"
