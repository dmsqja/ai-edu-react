const Chapter8Fragment = () => {
  return (
    <>
      ...
      <img src="/imgs/rag2.png" width="600px" alt="RAG" />
      <br />
      ...
      <img src="/imgs/etl.png" width="600px" alt="ETL Pipeline" />
      <br />
      <a href="https://docs.spring.io/spring-ai/reference/api/etl-pipeline.html">출처:docs.springai.io</a>
      <br />
      <br />
      ...
      <p>다음은 RAG를 위한 Spring Boot 의존성 구성 예시입니다.</p>
