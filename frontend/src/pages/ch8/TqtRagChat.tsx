...
const TqtRagChat = () => {
  const [question, setQuestion] = useState("What's your fasting blood sugar index");
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const responseText = 'TranslationQueryTransformer 응답 (백엔드 API 구현 후 실제 스트리밍으로 대체 예정)';
  ...
  return (
    <>
      <h2 className="text-center">7. RAG - TranslationQueryTransformer</h2>
