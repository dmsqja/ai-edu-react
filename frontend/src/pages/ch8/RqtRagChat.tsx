...
const RqtRagChat = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const responseText = 'RewriteQueryTransformer 응답 (백엔드 API 구현 후 실제 스트리밍으로 대체 예정)';
  ...
  return (
    <>
      <h2 className="text-center">6. RAG - RewriteQueryTransformer</h2>
