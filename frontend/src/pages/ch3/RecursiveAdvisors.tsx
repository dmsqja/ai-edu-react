...
const RecursiveAdvisors = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      // const response = await apiClient.post('/ch3/bean-output', 
      ...
      const responseText = '백엔드 API가 구현되면 실제 Recursive Advisors 응답이 표시됩니다.';
  ...
  return (
    <>
      <h2 className="text-center">3. Recursive Advisors</h2>
...
export default RecursiveAdvisors;
