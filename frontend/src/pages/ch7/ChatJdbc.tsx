...
const ChatJdbc = () => {
  ...
  return (
    <>
      <h2 className="text-center">4. Chat Client with ChatMemory(JDBC)</h2>
            ...
            <div className="card">
              <div className="card-header text-muted d-flex justify-content-start align-items-center p-3">
                <div className="input-group mb-0">
                  ...
                  />
                  <button type="button" className="btn btn-primary mr-2" onClick={sendMessage} disabled={loading}>
                    Send
                  </button>
                  <button
                    type="button"
