...
const GenerateImage = () => {
  const [question, setQuestion] = useState('서울 밤 풍경');
  ...
  const sendMessage = async () => {
    ...
    try {
      // 백엔드 API 호출
      const imageBase64 = await postRequest(
        '/ch4/generate-image',
  ...
  return (
    <>
      <h2 className="text-center">1. Generate Image</h2>
                        ...
                        <div className="d-flex flex-row justify-content-end mb-4 pt-1">
                          ...
                          >
                            {message.imageBase64 && (
                              <>
                                <a
                                  href={`data:image/png;base64,${message.imageBase64}`}
